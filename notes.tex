...
% You need to have XeLaTeX and Biber installed.
% Compile with `make` or `latexmk -xelatex notes.tex`.
...
\usepackage{tikz}
\usetikzlibrary{shapes.geometric, positioning, graphs, graphs.standard, chains,
  fit, shapes, calc}
\usepackage{wrapfig}
...
\footnotetext{The lecture notes were compiled from the
  \href{https://wikimpri.dptinfo.ens-cachan.fr/doku.php?id=cours:c-2-29-1}{MPRI
    2.29.1 course} given by Reza Nazerasr~\cite{NASERASR18}, Pierre
  Charbit~\cite{CHARBIT18}, and Pierluigi Crescenzi.}
